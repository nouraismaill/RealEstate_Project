...
<?php
$select = mysqli_query($conn,"SELECT * FROM props");
if ($select) {
  $props = [];
...
if(isset($_POST['submit'])){
    ...
    $offers =$_POST['offers'];
    $cities =$_POST['cities'];
    $query = "SELECT * FROM props WHERE (home_type LIKE '%$types%' OR type LIKE '%$offers%') AND location LIKE '%$cities%'";
...
<div class="site-section site-section-sm pb-0">
    ...
    <?php if (count($listings) > 0) : ?>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="property-entry h-100">
                    <a href="property-details.php?id=<?php echo $listing['id']; ?>" class="property-thumbnail">
                        ...
                        <img src="images/<?php echo $listing['image']; ?>" alt="Image" class="img-fluid thumbnail-image">
                    </a>
                    <div class="p-4 property-body">
                        <h2 class="property-title"><a
                                    href="property-details.php?id=<?php echo $listing['id']; ?>"><?php echo $listing['name']; ?></a>
                        </h2>
                        <span class="property-location d-block mb-3"><span
                                    class="property-icon icon-room"></span> <?php echo $listing['location']; ?></span>
                        <strong
        ...
        <?php endforeach; ?>
    <?php else : ?>
        <div class="alert alert-success bg-success text-white">We don't have any listings with this query for now</div>
    <?php endif; ?>
</div>
