...
?>
  ...
  <?php endforeach; ?>
    ...
    <div class="site-section site-section-sm bg-light">
      ...
      <div class="row mb-5">
    <?php foreach($allListings as $allListings): ?>
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="property-entry h-100">
            <a href="property-details.php?id=<?php echo isset($allListings['id']) ? $allListings['id'] : ''; ?>" class="property-thumbnail">
                    <div class="offer-type-wrap">
                        <span class="offer-type bg-<?php if($allListings['type'] == "rent") { echo "success"; } else { echo "danger";}?>"><?php echo isset($allListings['type']) ? $allListings['type'] : ''; ?></span>
                    </div>
                    <img src="images/<?php echo isset($allListings['image']) ? $allListings['image'] : ''; ?>" alt="Image" class="img-fluid thumbnail-image">
                </a>
                <div class="p-4 property-body">
                <h2 class="property-title"><a href="property-details.php?id=<?php echo $allListings['id']; ?>"><?php echo isset($allListings['name']) ? $allListings['name'] : ''; ?></a></h2>
                    <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span> <?php echo isset($allListings['location']) ? $allListings['location'] : ''; ?></span>
                    <strong class="property-price text-primary mb-3 d-block text-success">$<?php echo isset($allListings['price']) ? $allListings['price'] : ''; ?></strong>
                    <ul class="property-specs-wrap mb-3 mb-lg-0">
                        <li>
                            <span class="property-specs">Beds</span>
                            <span class="property-specs-number"><?php echo isset($allListings['beds']) ? $allListings['beds'] : ''; ?></span>
                        </li>
                        <li>
                            <span class="property-specs">Baths</span>
                            <span class="property-specs-number"><?php echo isset($allListings['baths']) ? $allListings['baths'] : ''; ?></span>
                        </li>
                        <li>
                            <span class="property-specs">SQ FT</span>
                            <span class="property-specs-number"><?php echo isset($allListings['sq_ft']) ? $allListings['sq_ft'] : ''; ?></span>
                        </li>
                    </ul>
                </div>
            </div>
